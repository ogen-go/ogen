...
type GenerateOptions struct {
	...
	NoClient bool `json:"no_client" yaml:"no_client"`
	// NoServer disables server generation.
	NoServer bool `json:"no_server" yaml:"no_server"`
	// NoWebhookClient disables webhook client generation.
	NoWebhookClient bool `json:"no_webhook_client" yaml:"no_webhook_client"`
	// NoWebhookServer disables webhook server generation.
	NoWebhookServer bool `json:"no_webhook_server" yaml:"no_webhook_server"`
	// NoUnimplemented disables generation of stub Handler, like UnimplementedServer generated by gRPC.
	NoUnimplemented bool `json:"no_unimplemented" yaml:"no_unimplemented"`

	// GenerateExampleTests whether to generate decoding tests using schema examples.
	GenerateExampleTests bool `json:"generate_tests" yaml:"generate_tests"`
