...
// Sample API matrix:
//go:generate go run ../cmd/ogen -v --debug.ignoreNotImplemented "enum format" --infer-types --clean --target sample_api --generate-tests ../_testdata/positive/sample.json
