...
func (c *Client) DefaultTest(ctx context.Context, request DefaultTest, params DefaultTestParams) (res int32, err error) {
	...
	fn, err := encodeDefaultTestRequestJSON(request, span)
	if err != nil {
		return res, err
	}
	reqBody = fn
...
func (c *Client) FoobarPost(ctx context.Context, request OptPet) (res FoobarPostRes, err error) {
	...
	contentType = "application/json"
	fn, err := encodeFoobarPostRequestJSON(request, span)
	if err != nil {
		return res, err
	}
	reqBody = fn
...
func (c *Client) OneofBug(ctx context.Context, request OneOfBugs) (res OneofBugOK, err error) {
	...
	contentType = "application/json"
	fn, err := encodeOneofBugRequestJSON(request, span)
	if err != nil {
		return res, err
	}
	reqBody = fn
...
func (c *Client) PetCreate(ctx context.Context, request OptPet) (res Pet, err error) {
	...
	contentType = "application/json"
	fn, err := encodePetCreateRequestJSON(request, span)
	if err != nil {
		return res, err
	}
	reqBody = fn
...
func (c *Client) PetUpdateNameAliasPost(ctx context.Context, request OptPetName) (res PetUpdateNameAliasPostDef, err error) {
	...
	contentType = "application/json"
	fn, err := encodePetUpdateNameAliasPostRequestJSON(request, span)
	if err != nil {
		return res, err
	}
	reqBody = fn
...
func (c *Client) PetUpdateNamePost(ctx context.Context, request OptString) (res PetUpdateNamePostDef, err error) {
	...
	contentType = "application/json"
	fn, err := encodePetUpdateNamePostRequestJSON(request, span)
	if err != nil {
		return res, err
	}
	reqBody = fn
...
func (c *Client) PetUploadAvatarByID(ctx context.Context, request PetUploadAvatarByIDReq, params PetUploadAvatarByIDParams) (res PetUploadAvatarByIDRes, err error) {
	...
	fn, err := encodePetUploadAvatarByIDRequestOctetStream(request, span)
	if err != nil {
		return res, err
	}
	reqBody = fn
...
func (c *Client) TestFloatValidation(ctx context.Context, request TestFloatValidation) (res TestFloatValidationOK, err error) {
	...
	contentType = "application/json"
	fn, err := encodeTestFloatValidationRequestJSON(request, span)
	if err != nil {
		return res, err
	}
	reqBody = fn
...
func (c *Client) TestFormURLEncoded(ctx context.Context, request TestForm) (res TestFormURLEncodedOK, err error) {
	...
	fn, err := encodeTestFormURLEncodedRequestFormURLEncoded(request, span)
	if err != nil {
		return res, err
	}
	reqBody = fn
...
func (c *Client) TestMultipart(ctx context.Context, request TestForm) (res TestMultipartOK, err error) {
	...
	fn, ct, err := encodeTestMultipartRequest(request, span)
	if err != nil {
		return res, err
	}
	reqBody = fn
...
func (c *Client) TestMultipartUpload(ctx context.Context, request TestMultipartUploadReq) (res string, err error) {
	...
	contentType = "multipart/form-data"
	fn, ct, err := encodeTestMultipartUploadRequest(request, span)
	if err != nil {
		return res, err
	}
	reqBody = fn
