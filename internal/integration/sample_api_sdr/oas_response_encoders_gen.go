...
func encodeErrorGetResponse(response ErrorGetRes, w http.ResponseWriter, span trace.Span) error {
...
func encodeFoobarPutResponse(response FoobarPutRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	default:
		return errors.Errorf("unexpected response type: %T", response)
	}
...
func encodeNullableDefaultResponseResponse(response NullableDefaultResponseRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	default:
		return errors.Errorf("unexpected response type: %T", response)
	}
...
func encodePetGetResponse(response *Pet, w http.ResponseWriter, span trace.Span) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(200)
	span.SetStatus(codes.Ok, http.StatusText(200))
...
func encodePetUpdateNameAliasPostResponse(response PetUpdateNameAliasPostRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	default:
		return errors.Errorf("unexpected response type: %T", response)
	}
...
func encodePetUpdateNamePostResponse(response PetUpdateNamePostRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	default:
		return errors.Errorf("unexpected response type: %T", response)
	}
