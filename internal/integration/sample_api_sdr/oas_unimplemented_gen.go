...
//
// GET /error
func (UnimplementedHandler) ErrorGet(ctx context.Context) (r ErrorGetRes, _ error) {
	return r, ht.ErrNotImplemented
}
...
//
// PUT /foobar
func (UnimplementedHandler) FoobarPut(ctx context.Context) (r FoobarPutRes, _ error) {
	return r, ht.ErrNotImplemented
}
...
func (UnimplementedHandler) NullableDefaultResponse(ctx context.Context) (r NullableDefaultResponseRes, _ error) {
	return r, ht.ErrNotImplemented
}
...
//
// GET /pet
func (UnimplementedHandler) PetGet(ctx context.Context, params PetGetParams) (r *Pet, _ error) {
	return r, ht.ErrNotImplemented
}
...
func (UnimplementedHandler) PetUpdateNameAliasPost(ctx context.Context, req OptPetName) (r PetUpdateNameAliasPostRes, _ error) {
	return r, ht.ErrNotImplemented
}
...
//
// POST /pet/updateName
func (UnimplementedHandler) PetUpdateNamePost(ctx context.Context, req OptString) (r PetUpdateNamePostRes, _ error) {
	return r, ht.ErrNotImplemented
}
