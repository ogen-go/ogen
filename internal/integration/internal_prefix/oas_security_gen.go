...
func (s *ApiServer) securityBasicAuth(ctx context.Context, operationName string, req *http.Request) (context.Context, bool, error) {
	var t BasicAuth
...
func (s *ApiServer) securityCookieKey(ctx context.Context, operationName string, req *http.Request) (context.Context, bool, error) {
	var t CookieKey
...
func (s *ApiServer) securityHeaderKey(ctx context.Context, operationName string, req *http.Request) (context.Context, bool, error) {
	var t HeaderKey
...
func (s *ApiServer) securityQueryKey(ctx context.Context, operationName string, req *http.Request) (context.Context, bool, error) {
	var t QueryKey
	const parameterName = "api_key"
	q := req.URL.Query()
...
func (s *ApiClient) securityBasicAuth(ctx context.Context, operationName string, req *http.Request) error {
...
func (s *ApiClient) securityCookieKey(ctx context.Context, operationName string, req *http.Request) error {
...
func (s *ApiClient) securityHeaderKey(ctx context.Context, operationName string, req *http.Request) error {
...
func (s *ApiClient) securityQueryKey(ctx context.Context, operationName string, req *http.Request) error {
