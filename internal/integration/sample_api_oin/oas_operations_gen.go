...
type Operations interface {
	...
	//
	// POST /foobar
	FoobarPost(ctx context.Context, req OptNilPet) (FoobarPostRes, error)
	...
	//
	// POST /pet
	PetCreate(ctx context.Context, req OptNilPet) (*Pet, error)
	...
	PetUpdateNameAliasPost(ctx context.Context, req OptNilPetName) (*PetUpdateNameAliasPostDef, error)
	// PetUpdateNamePost implements POST /pet/updateName operation.
	//
	// POST /pet/updateName
	PetUpdateNamePost(ctx context.Context, req OptNilString) (*PetUpdateNamePostDef, error)
