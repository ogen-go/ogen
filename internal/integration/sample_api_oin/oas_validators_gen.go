...
func (s *AnyTest) Validate() error {
	var failures []validate.FieldError
	if err := func() error {
		if value, ok := s.AnyArray.Get(); ok {
			if err := func() error {
				if value == nil {
...
func (s *Pet) Validate() error {
	...
	if err := func() error {
		if value, ok := s.TestArray1.Get(); ok {
			if err := func() error {
				if value == nil {
					return errors.New("nil is invalid value")
				}
