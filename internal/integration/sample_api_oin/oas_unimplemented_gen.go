...
//
// POST /foobar
func (UnimplementedHandler) FoobarPost(ctx context.Context, req OptNilPet) (r FoobarPostRes, _ error) {
	return r, ht.ErrNotImplemented
}
...
//
// POST /pet
func (UnimplementedHandler) PetCreate(ctx context.Context, req OptNilPet) (r *Pet, _ error) {
	return r, ht.ErrNotImplemented
}
...
func (UnimplementedHandler) PetUpdateNameAliasPost(ctx context.Context, req OptNilPetName) (r *PetUpdateNameAliasPostDef, _ error) {
	return r, ht.ErrNotImplemented
}
...
//
// POST /pet/updateName
func (UnimplementedHandler) PetUpdateNamePost(ctx context.Context, req OptNilString) (r *PetUpdateNamePostDef, _ error) {
	return r, ht.ErrNotImplemented
}
