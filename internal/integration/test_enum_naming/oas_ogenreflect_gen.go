...
var API = api{
	Paths: paths{
		ProbeLiveness: ogenreflect.RuntimeOperation{
			Name: "ProbeLiveness",
			ID:   "probeLiveness",
			Types: ogenreflect.OperationTypes{
				Responses: ogenreflect.ResponsesType{
					Type:            reflect.TypeOf(new(ProbeLivenessOK)).Elem(),
					Implementations: nil,
					PatternMap: map[string]ogenreflect.ResponseType{
						"200": ogenreflect.ResponseType{
							...
							Contents: ogenreflect.Contents{
								"application/json": reflect.TypeOf(new(ProbeLivenessOK)).Elem(),
							},
						},
					},
				},
