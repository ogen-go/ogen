...
func (s *TestRequestFormatTestReq) Validate() error {
	...
	if err := func() error {
		if s.RequiredArrayStringHTTPMinusDate == nil {
			return errors.New("nil is invalid value")
		}
		return nil
	}(); err != nil {
		failures = append(failures, validate.FieldError{
			Name:  "required_array_string_http-date",
			Error: err,
		})
	}
	if err := func() error {
	...
	if err := func() error {
		if s.RequiredDoubleArrayStringHTTPMinusDate == nil {
			return errors.New("nil is invalid value")
		}
		var failures []validate.FieldError
		for i, elem := range s.RequiredDoubleArrayStringHTTPMinusDate {
			if err := func() error {
				if elem == nil {
					return errors.New("nil is invalid value")
				}
		...
		failures = append(failures, validate.FieldError{
			Name:  "required_double_array_string_http-date",
			Error: err,
		})
	}
	if err := func() error {
	...
	if err := func() error {
		var failures []validate.FieldError
		for i, elem := range s.OptionalDoubleArrayStringHTTPMinusDate {
			if err := func() error {
				if elem == nil {
					return errors.New("nil is invalid value")
				}
		...
		failures = append(failures, validate.FieldError{
			Name:  "optional_double_array_string_http-date",
			Error: err,
		})
	}
	if err := func() error {
