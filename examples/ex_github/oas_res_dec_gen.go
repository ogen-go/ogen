...
func decodeUsersGetAuthenticatedResponse(resp *http.Response, span trace.Span) (res UsersGetAuthenticatedRes, err error) {
	...
	case 200:
		...
		case "application/json":
			...
			var response UsersGetAuthenticatedOK
			if err := func() error {
				if err := response.ReadJSON(d); err != nil {
					return err
				}
	...
	case 401:
		...
		case "application/json":
			...
			if err := func() error {
				if err := fmt.Errorf(`decoding of "UsersGetAuthenticatedApplicationJSONUnauthorized" (alias) is not implemented`); err != nil {
					return err
				}
				return nil
			}(); err != nil {
	...
	case 403:
		...
		case "application/json":
			...
			if err := func() error {
				if err := fmt.Errorf(`decoding of "UsersGetAuthenticatedApplicationJSONForbidden" (alias) is not implemented`); err != nil {
					return err
				}
				return nil
			}(); err != nil {
...
func decodeUsersGetByUsernameResponse(resp *http.Response, span trace.Span) (res UsersGetByUsernameRes, err error) {
	...
	case 200:
		...
		case "application/json":
			...
			var response UsersGetByUsernameOK
			if err := func() error {
				if err := response.ReadJSON(d); err != nil {
					return err
				}
