...
// UserPassloginPost invokes  operation.
//
// POST /user/passlogin
func (c *Client) UserPassloginPost(ctx context.Context, request UserPassloginPostReq, params UserPassloginPostParams) (res Passcode, err error) {
	startTime := time.Now()
	otelAttrs := []attribute.KeyValue{}
...
// UserPostingPost invokes  operation.
//
// POST /user/posting
func (c *Client) UserPostingPost(ctx context.Context, request UserPostingPostReq) (res UserPostingPostOK, err error) {
	if err := func() error {
...
// UserReportPost invokes  operation.
//
// POST /user/report
func (c *Client) UserReportPost(ctx context.Context, request UserReportPostReq) (res Report, err error) {
	startTime := time.Now()
	otelAttrs := []attribute.KeyValue{}
