...
func (s *Server) Register(mux chi.Mux) {
	mux.MethodFunc("GET", "/apis/", s.HandleGetAPIVersionsRequest)
	mux.MethodFunc("GET", "/apis/admissionregistration.k8s.io/", s.HandleGetAdmissionregistrationAPIGroupRequest)
	mux.MethodFunc("GET", "/apis/admissionregistration.k8s.io/v1/", s.HandleGetAdmissionregistrationV1APIResourcesRequest)
	mux.MethodFunc("GET", "/apis/apiextensions.k8s.io/", s.HandleGetApiextensionsAPIGroupRequest)
	mux.MethodFunc("GET", "/apis/apiextensions.k8s.io/v1/", s.HandleGetApiextensionsV1APIResourcesRequest)
	mux.MethodFunc("GET", "/apis/apiregistration.k8s.io/", s.HandleGetApiregistrationAPIGroupRequest)
	mux.MethodFunc("GET", "/apis/apiregistration.k8s.io/v1/", s.HandleGetApiregistrationV1APIResourcesRequest)
	mux.MethodFunc("GET", "/apis/apps/", s.HandleGetAppsAPIGroupRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/", s.HandleGetAppsV1APIResourcesRequest)
	mux.MethodFunc("GET", "/apis/authentication.k8s.io/", s.HandleGetAuthenticationAPIGroupRequest)
	mux.MethodFunc("GET", "/apis/authentication.k8s.io/v1/", s.HandleGetAuthenticationV1APIResourcesRequest)
	mux.MethodFunc("GET", "/apis/authorization.k8s.io/", s.HandleGetAuthorizationAPIGroupRequest)
	mux.MethodFunc("GET", "/apis/authorization.k8s.io/v1/", s.HandleGetAuthorizationV1APIResourcesRequest)
	mux.MethodFunc("GET", "/apis/autoscaling/", s.HandleGetAutoscalingAPIGroupRequest)
	mux.MethodFunc("GET", "/apis/autoscaling/v1/", s.HandleGetAutoscalingV1APIResourcesRequest)
	mux.MethodFunc("GET", "/apis/autoscaling/v2beta1/", s.HandleGetAutoscalingV2beta1APIResourcesRequest)
	mux.MethodFunc("GET", "/apis/autoscaling/v2beta2/", s.HandleGetAutoscalingV2beta2APIResourcesRequest)
	mux.MethodFunc("GET", "/apis/batch/", s.HandleGetBatchAPIGroupRequest)
	mux.MethodFunc("GET", "/apis/batch/v1/", s.HandleGetBatchV1APIResourcesRequest)
	mux.MethodFunc("GET", "/apis/batch/v1beta1/", s.HandleGetBatchV1beta1APIResourcesRequest)
	mux.MethodFunc("GET", "/apis/certificates.k8s.io/", s.HandleGetCertificatesAPIGroupRequest)
	mux.MethodFunc("GET", "/apis/certificates.k8s.io/v1/", s.HandleGetCertificatesV1APIResourcesRequest)
	mux.MethodFunc("GET", "/version/", s.HandleGetCodeVersionRequest)
	mux.MethodFunc("GET", "/apis/coordination.k8s.io/", s.HandleGetCoordinationAPIGroupRequest)
	mux.MethodFunc("GET", "/apis/coordination.k8s.io/v1/", s.HandleGetCoordinationV1APIResourcesRequest)
	mux.MethodFunc("GET", "/api/", s.HandleGetCoreAPIVersionsRequest)
	mux.MethodFunc("GET", "/api/v1/", s.HandleGetCoreV1APIResourcesRequest)
	mux.MethodFunc("GET", "/apis/discovery.k8s.io/", s.HandleGetDiscoveryAPIGroupRequest)
	mux.MethodFunc("GET", "/apis/discovery.k8s.io/v1/", s.HandleGetDiscoveryV1APIResourcesRequest)
	mux.MethodFunc("GET", "/apis/discovery.k8s.io/v1beta1/", s.HandleGetDiscoveryV1beta1APIResourcesRequest)
	mux.MethodFunc("GET", "/apis/events.k8s.io/", s.HandleGetEventsAPIGroupRequest)
	mux.MethodFunc("GET", "/apis/events.k8s.io/v1/", s.HandleGetEventsV1APIResourcesRequest)
	mux.MethodFunc("GET", "/apis/events.k8s.io/v1beta1/", s.HandleGetEventsV1beta1APIResourcesRequest)
	mux.MethodFunc("GET", "/apis/flowcontrol.apiserver.k8s.io/", s.HandleGetFlowcontrolApiserverAPIGroupRequest)
	mux.MethodFunc("GET", "/apis/flowcontrol.apiserver.k8s.io/v1beta1/", s.HandleGetFlowcontrolApiserverV1beta1APIResourcesRequest)
	mux.MethodFunc("GET", "/apis/flowcontrol.apiserver.k8s.io/v1beta2/", s.HandleGetFlowcontrolApiserverV1beta2APIResourcesRequest)
	mux.MethodFunc("GET", "/apis/internal.apiserver.k8s.io/", s.HandleGetInternalApiserverAPIGroupRequest)
	mux.MethodFunc("GET", "/apis/internal.apiserver.k8s.io/v1alpha1/", s.HandleGetInternalApiserverV1alpha1APIResourcesRequest)
	mux.MethodFunc("GET", "/apis/networking.k8s.io/", s.HandleGetNetworkingAPIGroupRequest)
	mux.MethodFunc("GET", "/apis/networking.k8s.io/v1/", s.HandleGetNetworkingV1APIResourcesRequest)
	mux.MethodFunc("GET", "/apis/node.k8s.io/", s.HandleGetNodeAPIGroupRequest)
	mux.MethodFunc("GET", "/apis/node.k8s.io/v1/", s.HandleGetNodeV1APIResourcesRequest)
	mux.MethodFunc("GET", "/apis/node.k8s.io/v1alpha1/", s.HandleGetNodeV1alpha1APIResourcesRequest)
	mux.MethodFunc("GET", "/apis/node.k8s.io/v1beta1/", s.HandleGetNodeV1beta1APIResourcesRequest)
	mux.MethodFunc("GET", "/apis/policy/", s.HandleGetPolicyAPIGroupRequest)
	mux.MethodFunc("GET", "/apis/policy/v1/", s.HandleGetPolicyV1APIResourcesRequest)
	mux.MethodFunc("GET", "/apis/policy/v1beta1/", s.HandleGetPolicyV1beta1APIResourcesRequest)
	mux.MethodFunc("GET", "/apis/rbac.authorization.k8s.io/", s.HandleGetRbacAuthorizationAPIGroupRequest)
	mux.MethodFunc("GET", "/apis/rbac.authorization.k8s.io/v1/", s.HandleGetRbacAuthorizationV1APIResourcesRequest)
	mux.MethodFunc("GET", "/apis/scheduling.k8s.io/", s.HandleGetSchedulingAPIGroupRequest)
	mux.MethodFunc("GET", "/apis/scheduling.k8s.io/v1/", s.HandleGetSchedulingV1APIResourcesRequest)
	mux.MethodFunc("GET", "/.well-known/openid-configuration/", s.HandleGetServiceAccountIssuerOpenIDConfigurationRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/", s.HandleGetStorageAPIGroupRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/v1/", s.HandleGetStorageV1APIResourcesRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/v1alpha1/", s.HandleGetStorageV1alpha1APIResourcesRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/v1beta1/", s.HandleGetStorageV1beta1APIResourcesRequest)
	mux.MethodFunc("GET", "/apis/admissionregistration.k8s.io/v1/mutatingwebhookconfigurations", s.HandleListAdmissionregistrationV1MutatingWebhookConfigurationRequest)
	mux.MethodFunc("GET", "/apis/admissionregistration.k8s.io/v1/validatingwebhookconfigurations", s.HandleListAdmissionregistrationV1ValidatingWebhookConfigurationRequest)
	mux.MethodFunc("GET", "/apis/apiextensions.k8s.io/v1/customresourcedefinitions", s.HandleListApiextensionsV1CustomResourceDefinitionRequest)
	mux.MethodFunc("GET", "/apis/apiregistration.k8s.io/v1/apiservices", s.HandleListApiregistrationV1APIServiceRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/controllerrevisions", s.HandleListAppsV1ControllerRevisionForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/daemonsets", s.HandleListAppsV1DaemonSetForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/deployments", s.HandleListAppsV1DeploymentForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/namespaces/{namespace}/controllerrevisions", s.HandleListAppsV1NamespacedControllerRevisionRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/namespaces/{namespace}/daemonsets", s.HandleListAppsV1NamespacedDaemonSetRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/namespaces/{namespace}/deployments", s.HandleListAppsV1NamespacedDeploymentRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/namespaces/{namespace}/replicasets", s.HandleListAppsV1NamespacedReplicaSetRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/namespaces/{namespace}/statefulsets", s.HandleListAppsV1NamespacedStatefulSetRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/replicasets", s.HandleListAppsV1ReplicaSetForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/statefulsets", s.HandleListAppsV1StatefulSetForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/autoscaling/v1/horizontalpodautoscalers", s.HandleListAutoscalingV1HorizontalPodAutoscalerForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers", s.HandleListAutoscalingV1NamespacedHorizontalPodAutoscalerRequest)
	mux.MethodFunc("GET", "/apis/autoscaling/v2beta1/horizontalpodautoscalers", s.HandleListAutoscalingV2beta1HorizontalPodAutoscalerForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/autoscaling/v2beta1/namespaces/{namespace}/horizontalpodautoscalers", s.HandleListAutoscalingV2beta1NamespacedHorizontalPodAutoscalerRequest)
	mux.MethodFunc("GET", "/apis/autoscaling/v2beta2/horizontalpodautoscalers", s.HandleListAutoscalingV2beta2HorizontalPodAutoscalerForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/autoscaling/v2beta2/namespaces/{namespace}/horizontalpodautoscalers", s.HandleListAutoscalingV2beta2NamespacedHorizontalPodAutoscalerRequest)
	mux.MethodFunc("GET", "/apis/batch/v1/cronjobs", s.HandleListBatchV1CronJobForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/batch/v1/jobs", s.HandleListBatchV1JobForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/batch/v1/namespaces/{namespace}/cronjobs", s.HandleListBatchV1NamespacedCronJobRequest)
	mux.MethodFunc("GET", "/apis/batch/v1/namespaces/{namespace}/jobs", s.HandleListBatchV1NamespacedJobRequest)
	mux.MethodFunc("GET", "/apis/batch/v1beta1/cronjobs", s.HandleListBatchV1beta1CronJobForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/batch/v1beta1/namespaces/{namespace}/cronjobs", s.HandleListBatchV1beta1NamespacedCronJobRequest)
	mux.MethodFunc("GET", "/apis/certificates.k8s.io/v1/certificatesigningrequests", s.HandleListCertificatesV1CertificateSigningRequestRequest)
	mux.MethodFunc("GET", "/apis/coordination.k8s.io/v1/leases", s.HandleListCoordinationV1LeaseForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/coordination.k8s.io/v1/namespaces/{namespace}/leases", s.HandleListCoordinationV1NamespacedLeaseRequest)
	mux.MethodFunc("GET", "/api/v1/componentstatuses", s.HandleListCoreV1ComponentStatusRequest)
	mux.MethodFunc("GET", "/api/v1/configmaps", s.HandleListCoreV1ConfigMapForAllNamespacesRequest)
	mux.MethodFunc("GET", "/api/v1/endpoints", s.HandleListCoreV1EndpointsForAllNamespacesRequest)
	mux.MethodFunc("GET", "/api/v1/events", s.HandleListCoreV1EventForAllNamespacesRequest)
	mux.MethodFunc("GET", "/api/v1/limitranges", s.HandleListCoreV1LimitRangeForAllNamespacesRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces", s.HandleListCoreV1NamespaceRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{namespace}/configmaps", s.HandleListCoreV1NamespacedConfigMapRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{namespace}/endpoints", s.HandleListCoreV1NamespacedEndpointsRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{namespace}/events", s.HandleListCoreV1NamespacedEventRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{namespace}/limitranges", s.HandleListCoreV1NamespacedLimitRangeRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{namespace}/persistentvolumeclaims", s.HandleListCoreV1NamespacedPersistentVolumeClaimRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{namespace}/pods", s.HandleListCoreV1NamespacedPodRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{namespace}/podtemplates", s.HandleListCoreV1NamespacedPodTemplateRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{namespace}/replicationcontrollers", s.HandleListCoreV1NamespacedReplicationControllerRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{namespace}/resourcequotas", s.HandleListCoreV1NamespacedResourceQuotaRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{namespace}/secrets", s.HandleListCoreV1NamespacedSecretRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{namespace}/services", s.HandleListCoreV1NamespacedServiceRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{namespace}/serviceaccounts", s.HandleListCoreV1NamespacedServiceAccountRequest)
	mux.MethodFunc("GET", "/api/v1/nodes", s.HandleListCoreV1NodeRequest)
	mux.MethodFunc("GET", "/api/v1/persistentvolumes", s.HandleListCoreV1PersistentVolumeRequest)
	mux.MethodFunc("GET", "/api/v1/persistentvolumeclaims", s.HandleListCoreV1PersistentVolumeClaimForAllNamespacesRequest)
	mux.MethodFunc("GET", "/api/v1/pods", s.HandleListCoreV1PodForAllNamespacesRequest)
	mux.MethodFunc("GET", "/api/v1/podtemplates", s.HandleListCoreV1PodTemplateForAllNamespacesRequest)
	mux.MethodFunc("GET", "/api/v1/replicationcontrollers", s.HandleListCoreV1ReplicationControllerForAllNamespacesRequest)
	mux.MethodFunc("GET", "/api/v1/resourcequotas", s.HandleListCoreV1ResourceQuotaForAllNamespacesRequest)
	mux.MethodFunc("GET", "/api/v1/secrets", s.HandleListCoreV1SecretForAllNamespacesRequest)
	mux.MethodFunc("GET", "/api/v1/serviceaccounts", s.HandleListCoreV1ServiceAccountForAllNamespacesRequest)
	mux.MethodFunc("GET", "/api/v1/services", s.HandleListCoreV1ServiceForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/discovery.k8s.io/v1/endpointslices", s.HandleListDiscoveryV1EndpointSliceForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/discovery.k8s.io/v1/namespaces/{namespace}/endpointslices", s.HandleListDiscoveryV1NamespacedEndpointSliceRequest)
	mux.MethodFunc("GET", "/apis/discovery.k8s.io/v1beta1/endpointslices", s.HandleListDiscoveryV1beta1EndpointSliceForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/discovery.k8s.io/v1beta1/namespaces/{namespace}/endpointslices", s.HandleListDiscoveryV1beta1NamespacedEndpointSliceRequest)
	mux.MethodFunc("GET", "/apis/events.k8s.io/v1/events", s.HandleListEventsV1EventForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/events.k8s.io/v1/namespaces/{namespace}/events", s.HandleListEventsV1NamespacedEventRequest)
	mux.MethodFunc("GET", "/apis/events.k8s.io/v1beta1/events", s.HandleListEventsV1beta1EventForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/events.k8s.io/v1beta1/namespaces/{namespace}/events", s.HandleListEventsV1beta1NamespacedEventRequest)
	mux.MethodFunc("GET", "/apis/flowcontrol.apiserver.k8s.io/v1beta1/flowschemas", s.HandleListFlowcontrolApiserverV1beta1FlowSchemaRequest)
	mux.MethodFunc("GET", "/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations", s.HandleListFlowcontrolApiserverV1beta1PriorityLevelConfigurationRequest)
	mux.MethodFunc("GET", "/apis/flowcontrol.apiserver.k8s.io/v1beta2/flowschemas", s.HandleListFlowcontrolApiserverV1beta2FlowSchemaRequest)
	mux.MethodFunc("GET", "/apis/flowcontrol.apiserver.k8s.io/v1beta2/prioritylevelconfigurations", s.HandleListFlowcontrolApiserverV1beta2PriorityLevelConfigurationRequest)
	mux.MethodFunc("GET", "/apis/internal.apiserver.k8s.io/v1alpha1/storageversions", s.HandleListInternalApiserverV1alpha1StorageVersionRequest)
	mux.MethodFunc("GET", "/apis/networking.k8s.io/v1/ingressclasses", s.HandleListNetworkingV1IngressClassRequest)
	mux.MethodFunc("GET", "/apis/networking.k8s.io/v1/ingresses", s.HandleListNetworkingV1IngressForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/networking.k8s.io/v1/namespaces/{namespace}/ingresses", s.HandleListNetworkingV1NamespacedIngressRequest)
	mux.MethodFunc("GET", "/apis/networking.k8s.io/v1/namespaces/{namespace}/networkpolicies", s.HandleListNetworkingV1NamespacedNetworkPolicyRequest)
	mux.MethodFunc("GET", "/apis/networking.k8s.io/v1/networkpolicies", s.HandleListNetworkingV1NetworkPolicyForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/node.k8s.io/v1/runtimeclasses", s.HandleListNodeV1RuntimeClassRequest)
	mux.MethodFunc("GET", "/apis/node.k8s.io/v1alpha1/runtimeclasses", s.HandleListNodeV1alpha1RuntimeClassRequest)
	mux.MethodFunc("GET", "/apis/node.k8s.io/v1beta1/runtimeclasses", s.HandleListNodeV1beta1RuntimeClassRequest)
	mux.MethodFunc("GET", "/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets", s.HandleListPolicyV1NamespacedPodDisruptionBudgetRequest)
	mux.MethodFunc("GET", "/apis/policy/v1/poddisruptionbudgets", s.HandleListPolicyV1PodDisruptionBudgetForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets", s.HandleListPolicyV1beta1NamespacedPodDisruptionBudgetRequest)
	mux.MethodFunc("GET", "/apis/policy/v1beta1/poddisruptionbudgets", s.HandleListPolicyV1beta1PodDisruptionBudgetForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/policy/v1beta1/podsecuritypolicies", s.HandleListPolicyV1beta1PodSecurityPolicyRequest)
	mux.MethodFunc("GET", "/apis/rbac.authorization.k8s.io/v1/clusterroles", s.HandleListRbacAuthorizationV1ClusterRoleRequest)
	mux.MethodFunc("GET", "/apis/rbac.authorization.k8s.io/v1/clusterrolebindings", s.HandleListRbacAuthorizationV1ClusterRoleBindingRequest)
	mux.MethodFunc("GET", "/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/roles", s.HandleListRbacAuthorizationV1NamespacedRoleRequest)
	mux.MethodFunc("GET", "/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/rolebindings", s.HandleListRbacAuthorizationV1NamespacedRoleBindingRequest)
	mux.MethodFunc("GET", "/apis/rbac.authorization.k8s.io/v1/rolebindings", s.HandleListRbacAuthorizationV1RoleBindingForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/rbac.authorization.k8s.io/v1/roles", s.HandleListRbacAuthorizationV1RoleForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/scheduling.k8s.io/v1/priorityclasses", s.HandleListSchedulingV1PriorityClassRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/v1/csidrivers", s.HandleListStorageV1CSIDriverRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/v1/csinodes", s.HandleListStorageV1CSINodeRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/v1/storageclasses", s.HandleListStorageV1StorageClassRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/v1/volumeattachments", s.HandleListStorageV1VolumeAttachmentRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/v1alpha1/csistoragecapacities", s.HandleListStorageV1alpha1CSIStorageCapacityForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/v1alpha1/namespaces/{namespace}/csistoragecapacities", s.HandleListStorageV1alpha1NamespacedCSIStorageCapacityRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/v1beta1/csistoragecapacities", s.HandleListStorageV1beta1CSIStorageCapacityForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/v1beta1/namespaces/{namespace}/csistoragecapacities", s.HandleListStorageV1beta1NamespacedCSIStorageCapacityRequest)
	mux.MethodFunc("GET", "/logs/{logpath}", s.HandleLogFileHandlerRequest)
	mux.MethodFunc("GET", "/logs/", s.HandleLogFileListHandlerRequest)
	mux.MethodFunc("GET", "/apis/admissionregistration.k8s.io/v1/mutatingwebhookconfigurations/{name}", s.HandleReadAdmissionregistrationV1MutatingWebhookConfigurationRequest)
	mux.MethodFunc("GET", "/apis/admissionregistration.k8s.io/v1/validatingwebhookconfigurations/{name}", s.HandleReadAdmissionregistrationV1ValidatingWebhookConfigurationRequest)
	mux.MethodFunc("GET", "/apis/apiextensions.k8s.io/v1/customresourcedefinitions/{name}", s.HandleReadApiextensionsV1CustomResourceDefinitionRequest)
	mux.MethodFunc("GET", "/apis/apiextensions.k8s.io/v1/customresourcedefinitions/{name}/status", s.HandleReadApiextensionsV1CustomResourceDefinitionStatusRequest)
	mux.MethodFunc("GET", "/apis/apiregistration.k8s.io/v1/apiservices/{name}", s.HandleReadApiregistrationV1APIServiceRequest)
	mux.MethodFunc("GET", "/apis/apiregistration.k8s.io/v1/apiservices/{name}/status", s.HandleReadApiregistrationV1APIServiceStatusRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/namespaces/{namespace}/controllerrevisions/{name}", s.HandleReadAppsV1NamespacedControllerRevisionRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/namespaces/{namespace}/daemonsets/{name}", s.HandleReadAppsV1NamespacedDaemonSetRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/namespaces/{namespace}/daemonsets/{name}/status", s.HandleReadAppsV1NamespacedDaemonSetStatusRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/namespaces/{namespace}/deployments/{name}", s.HandleReadAppsV1NamespacedDeploymentRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/namespaces/{namespace}/deployments/{name}/scale", s.HandleReadAppsV1NamespacedDeploymentScaleRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/namespaces/{namespace}/deployments/{name}/status", s.HandleReadAppsV1NamespacedDeploymentStatusRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/namespaces/{namespace}/replicasets/{name}", s.HandleReadAppsV1NamespacedReplicaSetRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/namespaces/{namespace}/replicasets/{name}/scale", s.HandleReadAppsV1NamespacedReplicaSetScaleRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/namespaces/{namespace}/replicasets/{name}/status", s.HandleReadAppsV1NamespacedReplicaSetStatusRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/namespaces/{namespace}/statefulsets/{name}", s.HandleReadAppsV1NamespacedStatefulSetRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/namespaces/{namespace}/statefulsets/{name}/scale", s.HandleReadAppsV1NamespacedStatefulSetScaleRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/namespaces/{namespace}/statefulsets/{name}/status", s.HandleReadAppsV1NamespacedStatefulSetStatusRequest)
	mux.MethodFunc("GET", "/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name}", s.HandleReadAutoscalingV1NamespacedHorizontalPodAutoscalerRequest)
	mux.MethodFunc("GET", "/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name}/status", s.HandleReadAutoscalingV1NamespacedHorizontalPodAutoscalerStatusRequest)
	mux.MethodFunc("GET", "/apis/autoscaling/v2beta1/namespaces/{namespace}/horizontalpodautoscalers/{name}", s.HandleReadAutoscalingV2beta1NamespacedHorizontalPodAutoscalerRequest)
	mux.MethodFunc("GET", "/apis/autoscaling/v2beta1/namespaces/{namespace}/horizontalpodautoscalers/{name}/status", s.HandleReadAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatusRequest)
	mux.MethodFunc("GET", "/apis/autoscaling/v2beta2/namespaces/{namespace}/horizontalpodautoscalers/{name}", s.HandleReadAutoscalingV2beta2NamespacedHorizontalPodAutoscalerRequest)
	mux.MethodFunc("GET", "/apis/autoscaling/v2beta2/namespaces/{namespace}/horizontalpodautoscalers/{name}/status", s.HandleReadAutoscalingV2beta2NamespacedHorizontalPodAutoscalerStatusRequest)
	mux.MethodFunc("GET", "/apis/batch/v1/namespaces/{namespace}/cronjobs/{name}", s.HandleReadBatchV1NamespacedCronJobRequest)
	mux.MethodFunc("GET", "/apis/batch/v1/namespaces/{namespace}/cronjobs/{name}/status", s.HandleReadBatchV1NamespacedCronJobStatusRequest)
	mux.MethodFunc("GET", "/apis/batch/v1/namespaces/{namespace}/jobs/{name}", s.HandleReadBatchV1NamespacedJobRequest)
	mux.MethodFunc("GET", "/apis/batch/v1/namespaces/{namespace}/jobs/{name}/status", s.HandleReadBatchV1NamespacedJobStatusRequest)
	mux.MethodFunc("GET", "/apis/batch/v1beta1/namespaces/{namespace}/cronjobs/{name}", s.HandleReadBatchV1beta1NamespacedCronJobRequest)
	mux.MethodFunc("GET", "/apis/batch/v1beta1/namespaces/{namespace}/cronjobs/{name}/status", s.HandleReadBatchV1beta1NamespacedCronJobStatusRequest)
	mux.MethodFunc("GET", "/apis/certificates.k8s.io/v1/certificatesigningrequests/{name}", s.HandleReadCertificatesV1CertificateSigningRequestRequest)
	mux.MethodFunc("GET", "/apis/certificates.k8s.io/v1/certificatesigningrequests/{name}/approval", s.HandleReadCertificatesV1CertificateSigningRequestApprovalRequest)
	mux.MethodFunc("GET", "/apis/certificates.k8s.io/v1/certificatesigningrequests/{name}/status", s.HandleReadCertificatesV1CertificateSigningRequestStatusRequest)
	mux.MethodFunc("GET", "/apis/coordination.k8s.io/v1/namespaces/{namespace}/leases/{name}", s.HandleReadCoordinationV1NamespacedLeaseRequest)
	mux.MethodFunc("GET", "/api/v1/componentstatuses/{name}", s.HandleReadCoreV1ComponentStatusRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{name}", s.HandleReadCoreV1NamespaceRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{name}/status", s.HandleReadCoreV1NamespaceStatusRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{namespace}/configmaps/{name}", s.HandleReadCoreV1NamespacedConfigMapRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{namespace}/endpoints/{name}", s.HandleReadCoreV1NamespacedEndpointsRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{namespace}/events/{name}", s.HandleReadCoreV1NamespacedEventRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{namespace}/limitranges/{name}", s.HandleReadCoreV1NamespacedLimitRangeRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{namespace}/persistentvolumeclaims/{name}", s.HandleReadCoreV1NamespacedPersistentVolumeClaimRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{namespace}/persistentvolumeclaims/{name}/status", s.HandleReadCoreV1NamespacedPersistentVolumeClaimStatusRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{namespace}/pods/{name}", s.HandleReadCoreV1NamespacedPodRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{namespace}/pods/{name}/ephemeralcontainers", s.HandleReadCoreV1NamespacedPodEphemeralcontainersRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{namespace}/pods/{name}/log", s.HandleReadCoreV1NamespacedPodLogRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{namespace}/pods/{name}/status", s.HandleReadCoreV1NamespacedPodStatusRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{namespace}/podtemplates/{name}", s.HandleReadCoreV1NamespacedPodTemplateRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{namespace}/replicationcontrollers/{name}", s.HandleReadCoreV1NamespacedReplicationControllerRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{namespace}/replicationcontrollers/{name}/scale", s.HandleReadCoreV1NamespacedReplicationControllerScaleRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{namespace}/replicationcontrollers/{name}/status", s.HandleReadCoreV1NamespacedReplicationControllerStatusRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{namespace}/resourcequotas/{name}", s.HandleReadCoreV1NamespacedResourceQuotaRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{namespace}/resourcequotas/{name}/status", s.HandleReadCoreV1NamespacedResourceQuotaStatusRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{namespace}/secrets/{name}", s.HandleReadCoreV1NamespacedSecretRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{namespace}/services/{name}", s.HandleReadCoreV1NamespacedServiceRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{namespace}/serviceaccounts/{name}", s.HandleReadCoreV1NamespacedServiceAccountRequest)
	mux.MethodFunc("GET", "/api/v1/namespaces/{namespace}/services/{name}/status", s.HandleReadCoreV1NamespacedServiceStatusRequest)
	mux.MethodFunc("GET", "/api/v1/nodes/{name}", s.HandleReadCoreV1NodeRequest)
	mux.MethodFunc("GET", "/api/v1/nodes/{name}/status", s.HandleReadCoreV1NodeStatusRequest)
	mux.MethodFunc("GET", "/api/v1/persistentvolumes/{name}", s.HandleReadCoreV1PersistentVolumeRequest)
	mux.MethodFunc("GET", "/api/v1/persistentvolumes/{name}/status", s.HandleReadCoreV1PersistentVolumeStatusRequest)
	mux.MethodFunc("GET", "/apis/discovery.k8s.io/v1/namespaces/{namespace}/endpointslices/{name}", s.HandleReadDiscoveryV1NamespacedEndpointSliceRequest)
	mux.MethodFunc("GET", "/apis/discovery.k8s.io/v1beta1/namespaces/{namespace}/endpointslices/{name}", s.HandleReadDiscoveryV1beta1NamespacedEndpointSliceRequest)
	mux.MethodFunc("GET", "/apis/events.k8s.io/v1/namespaces/{namespace}/events/{name}", s.HandleReadEventsV1NamespacedEventRequest)
	mux.MethodFunc("GET", "/apis/events.k8s.io/v1beta1/namespaces/{namespace}/events/{name}", s.HandleReadEventsV1beta1NamespacedEventRequest)
	mux.MethodFunc("GET", "/apis/flowcontrol.apiserver.k8s.io/v1beta1/flowschemas/{name}", s.HandleReadFlowcontrolApiserverV1beta1FlowSchemaRequest)
	mux.MethodFunc("GET", "/apis/flowcontrol.apiserver.k8s.io/v1beta1/flowschemas/{name}/status", s.HandleReadFlowcontrolApiserverV1beta1FlowSchemaStatusRequest)
	mux.MethodFunc("GET", "/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations/{name}", s.HandleReadFlowcontrolApiserverV1beta1PriorityLevelConfigurationRequest)
	mux.MethodFunc("GET", "/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations/{name}/status", s.HandleReadFlowcontrolApiserverV1beta1PriorityLevelConfigurationStatusRequest)
	mux.MethodFunc("GET", "/apis/flowcontrol.apiserver.k8s.io/v1beta2/flowschemas/{name}", s.HandleReadFlowcontrolApiserverV1beta2FlowSchemaRequest)
	mux.MethodFunc("GET", "/apis/flowcontrol.apiserver.k8s.io/v1beta2/flowschemas/{name}/status", s.HandleReadFlowcontrolApiserverV1beta2FlowSchemaStatusRequest)
	mux.MethodFunc("GET", "/apis/flowcontrol.apiserver.k8s.io/v1beta2/prioritylevelconfigurations/{name}", s.HandleReadFlowcontrolApiserverV1beta2PriorityLevelConfigurationRequest)
	mux.MethodFunc("GET", "/apis/flowcontrol.apiserver.k8s.io/v1beta2/prioritylevelconfigurations/{name}/status", s.HandleReadFlowcontrolApiserverV1beta2PriorityLevelConfigurationStatusRequest)
	mux.MethodFunc("GET", "/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}", s.HandleReadInternalApiserverV1alpha1StorageVersionRequest)
	mux.MethodFunc("GET", "/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}/status", s.HandleReadInternalApiserverV1alpha1StorageVersionStatusRequest)
	mux.MethodFunc("GET", "/apis/networking.k8s.io/v1/ingressclasses/{name}", s.HandleReadNetworkingV1IngressClassRequest)
	mux.MethodFunc("GET", "/apis/networking.k8s.io/v1/namespaces/{namespace}/ingresses/{name}", s.HandleReadNetworkingV1NamespacedIngressRequest)
	mux.MethodFunc("GET", "/apis/networking.k8s.io/v1/namespaces/{namespace}/ingresses/{name}/status", s.HandleReadNetworkingV1NamespacedIngressStatusRequest)
	mux.MethodFunc("GET", "/apis/networking.k8s.io/v1/namespaces/{namespace}/networkpolicies/{name}", s.HandleReadNetworkingV1NamespacedNetworkPolicyRequest)
	mux.MethodFunc("GET", "/apis/node.k8s.io/v1/runtimeclasses/{name}", s.HandleReadNodeV1RuntimeClassRequest)
	mux.MethodFunc("GET", "/apis/node.k8s.io/v1alpha1/runtimeclasses/{name}", s.HandleReadNodeV1alpha1RuntimeClassRequest)
	mux.MethodFunc("GET", "/apis/node.k8s.io/v1beta1/runtimeclasses/{name}", s.HandleReadNodeV1beta1RuntimeClassRequest)
	mux.MethodFunc("GET", "/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets/{name}", s.HandleReadPolicyV1NamespacedPodDisruptionBudgetRequest)
	mux.MethodFunc("GET", "/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets/{name}/status", s.HandleReadPolicyV1NamespacedPodDisruptionBudgetStatusRequest)
	mux.MethodFunc("GET", "/apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets/{name}", s.HandleReadPolicyV1beta1NamespacedPodDisruptionBudgetRequest)
	mux.MethodFunc("GET", "/apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets/{name}/status", s.HandleReadPolicyV1beta1NamespacedPodDisruptionBudgetStatusRequest)
	mux.MethodFunc("GET", "/apis/policy/v1beta1/podsecuritypolicies/{name}", s.HandleReadPolicyV1beta1PodSecurityPolicyRequest)
	mux.MethodFunc("GET", "/apis/rbac.authorization.k8s.io/v1/clusterroles/{name}", s.HandleReadRbacAuthorizationV1ClusterRoleRequest)
	mux.MethodFunc("GET", "/apis/rbac.authorization.k8s.io/v1/clusterrolebindings/{name}", s.HandleReadRbacAuthorizationV1ClusterRoleBindingRequest)
	mux.MethodFunc("GET", "/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/roles/{name}", s.HandleReadRbacAuthorizationV1NamespacedRoleRequest)
	mux.MethodFunc("GET", "/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/rolebindings/{name}", s.HandleReadRbacAuthorizationV1NamespacedRoleBindingRequest)
	mux.MethodFunc("GET", "/apis/scheduling.k8s.io/v1/priorityclasses/{name}", s.HandleReadSchedulingV1PriorityClassRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/v1/csidrivers/{name}", s.HandleReadStorageV1CSIDriverRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/v1/csinodes/{name}", s.HandleReadStorageV1CSINodeRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/v1/storageclasses/{name}", s.HandleReadStorageV1StorageClassRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/v1/volumeattachments/{name}", s.HandleReadStorageV1VolumeAttachmentRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/v1/volumeattachments/{name}/status", s.HandleReadStorageV1VolumeAttachmentStatusRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/v1alpha1/namespaces/{namespace}/csistoragecapacities/{name}", s.HandleReadStorageV1alpha1NamespacedCSIStorageCapacityRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/v1beta1/namespaces/{namespace}/csistoragecapacities/{name}", s.HandleReadStorageV1beta1NamespacedCSIStorageCapacityRequest)
	mux.MethodFunc("GET", "/apis/admissionregistration.k8s.io/v1/watch/mutatingwebhookconfigurations/{name}", s.HandleWatchAdmissionregistrationV1MutatingWebhookConfigurationRequest)
	mux.MethodFunc("GET", "/apis/admissionregistration.k8s.io/v1/watch/mutatingwebhookconfigurations", s.HandleWatchAdmissionregistrationV1MutatingWebhookConfigurationListRequest)
	mux.MethodFunc("GET", "/apis/admissionregistration.k8s.io/v1/watch/validatingwebhookconfigurations/{name}", s.HandleWatchAdmissionregistrationV1ValidatingWebhookConfigurationRequest)
	mux.MethodFunc("GET", "/apis/admissionregistration.k8s.io/v1/watch/validatingwebhookconfigurations", s.HandleWatchAdmissionregistrationV1ValidatingWebhookConfigurationListRequest)
	mux.MethodFunc("GET", "/apis/apiextensions.k8s.io/v1/watch/customresourcedefinitions/{name}", s.HandleWatchApiextensionsV1CustomResourceDefinitionRequest)
	mux.MethodFunc("GET", "/apis/apiextensions.k8s.io/v1/watch/customresourcedefinitions", s.HandleWatchApiextensionsV1CustomResourceDefinitionListRequest)
	mux.MethodFunc("GET", "/apis/apiregistration.k8s.io/v1/watch/apiservices/{name}", s.HandleWatchApiregistrationV1APIServiceRequest)
	mux.MethodFunc("GET", "/apis/apiregistration.k8s.io/v1/watch/apiservices", s.HandleWatchApiregistrationV1APIServiceListRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/watch/controllerrevisions", s.HandleWatchAppsV1ControllerRevisionListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/watch/daemonsets", s.HandleWatchAppsV1DaemonSetListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/watch/deployments", s.HandleWatchAppsV1DeploymentListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/watch/namespaces/{namespace}/controllerrevisions/{name}", s.HandleWatchAppsV1NamespacedControllerRevisionRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/watch/namespaces/{namespace}/controllerrevisions", s.HandleWatchAppsV1NamespacedControllerRevisionListRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/watch/namespaces/{namespace}/daemonsets/{name}", s.HandleWatchAppsV1NamespacedDaemonSetRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/watch/namespaces/{namespace}/daemonsets", s.HandleWatchAppsV1NamespacedDaemonSetListRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/watch/namespaces/{namespace}/deployments/{name}", s.HandleWatchAppsV1NamespacedDeploymentRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/watch/namespaces/{namespace}/deployments", s.HandleWatchAppsV1NamespacedDeploymentListRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/watch/namespaces/{namespace}/replicasets/{name}", s.HandleWatchAppsV1NamespacedReplicaSetRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/watch/namespaces/{namespace}/replicasets", s.HandleWatchAppsV1NamespacedReplicaSetListRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/watch/namespaces/{namespace}/statefulsets/{name}", s.HandleWatchAppsV1NamespacedStatefulSetRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/watch/namespaces/{namespace}/statefulsets", s.HandleWatchAppsV1NamespacedStatefulSetListRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/watch/replicasets", s.HandleWatchAppsV1ReplicaSetListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/apps/v1/watch/statefulsets", s.HandleWatchAppsV1StatefulSetListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/autoscaling/v1/watch/horizontalpodautoscalers", s.HandleWatchAutoscalingV1HorizontalPodAutoscalerListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/autoscaling/v1/watch/namespaces/{namespace}/horizontalpodautoscalers/{name}", s.HandleWatchAutoscalingV1NamespacedHorizontalPodAutoscalerRequest)
	mux.MethodFunc("GET", "/apis/autoscaling/v1/watch/namespaces/{namespace}/horizontalpodautoscalers", s.HandleWatchAutoscalingV1NamespacedHorizontalPodAutoscalerListRequest)
	mux.MethodFunc("GET", "/apis/autoscaling/v2beta1/watch/horizontalpodautoscalers", s.HandleWatchAutoscalingV2beta1HorizontalPodAutoscalerListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/autoscaling/v2beta1/watch/namespaces/{namespace}/horizontalpodautoscalers/{name}", s.HandleWatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerRequest)
	mux.MethodFunc("GET", "/apis/autoscaling/v2beta1/watch/namespaces/{namespace}/horizontalpodautoscalers", s.HandleWatchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerListRequest)
	mux.MethodFunc("GET", "/apis/autoscaling/v2beta2/watch/horizontalpodautoscalers", s.HandleWatchAutoscalingV2beta2HorizontalPodAutoscalerListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/autoscaling/v2beta2/watch/namespaces/{namespace}/horizontalpodautoscalers/{name}", s.HandleWatchAutoscalingV2beta2NamespacedHorizontalPodAutoscalerRequest)
	mux.MethodFunc("GET", "/apis/autoscaling/v2beta2/watch/namespaces/{namespace}/horizontalpodautoscalers", s.HandleWatchAutoscalingV2beta2NamespacedHorizontalPodAutoscalerListRequest)
	mux.MethodFunc("GET", "/apis/batch/v1/watch/cronjobs", s.HandleWatchBatchV1CronJobListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/batch/v1/watch/jobs", s.HandleWatchBatchV1JobListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/batch/v1/watch/namespaces/{namespace}/cronjobs/{name}", s.HandleWatchBatchV1NamespacedCronJobRequest)
	mux.MethodFunc("GET", "/apis/batch/v1/watch/namespaces/{namespace}/cronjobs", s.HandleWatchBatchV1NamespacedCronJobListRequest)
	mux.MethodFunc("GET", "/apis/batch/v1/watch/namespaces/{namespace}/jobs/{name}", s.HandleWatchBatchV1NamespacedJobRequest)
	mux.MethodFunc("GET", "/apis/batch/v1/watch/namespaces/{namespace}/jobs", s.HandleWatchBatchV1NamespacedJobListRequest)
	mux.MethodFunc("GET", "/apis/batch/v1beta1/watch/cronjobs", s.HandleWatchBatchV1beta1CronJobListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/batch/v1beta1/watch/namespaces/{namespace}/cronjobs/{name}", s.HandleWatchBatchV1beta1NamespacedCronJobRequest)
	mux.MethodFunc("GET", "/apis/batch/v1beta1/watch/namespaces/{namespace}/cronjobs", s.HandleWatchBatchV1beta1NamespacedCronJobListRequest)
	mux.MethodFunc("GET", "/apis/certificates.k8s.io/v1/watch/certificatesigningrequests/{name}", s.HandleWatchCertificatesV1CertificateSigningRequestRequest)
	mux.MethodFunc("GET", "/apis/certificates.k8s.io/v1/watch/certificatesigningrequests", s.HandleWatchCertificatesV1CertificateSigningRequestListRequest)
	mux.MethodFunc("GET", "/apis/coordination.k8s.io/v1/watch/leases", s.HandleWatchCoordinationV1LeaseListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/coordination.k8s.io/v1/watch/namespaces/{namespace}/leases/{name}", s.HandleWatchCoordinationV1NamespacedLeaseRequest)
	mux.MethodFunc("GET", "/apis/coordination.k8s.io/v1/watch/namespaces/{namespace}/leases", s.HandleWatchCoordinationV1NamespacedLeaseListRequest)
	mux.MethodFunc("GET", "/api/v1/watch/configmaps", s.HandleWatchCoreV1ConfigMapListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/api/v1/watch/endpoints", s.HandleWatchCoreV1EndpointsListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/api/v1/watch/events", s.HandleWatchCoreV1EventListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/api/v1/watch/limitranges", s.HandleWatchCoreV1LimitRangeListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/api/v1/watch/namespaces/{name}", s.HandleWatchCoreV1NamespaceRequest)
	mux.MethodFunc("GET", "/api/v1/watch/namespaces", s.HandleWatchCoreV1NamespaceListRequest)
	mux.MethodFunc("GET", "/api/v1/watch/namespaces/{namespace}/configmaps/{name}", s.HandleWatchCoreV1NamespacedConfigMapRequest)
	mux.MethodFunc("GET", "/api/v1/watch/namespaces/{namespace}/configmaps", s.HandleWatchCoreV1NamespacedConfigMapListRequest)
	mux.MethodFunc("GET", "/api/v1/watch/namespaces/{namespace}/endpoints/{name}", s.HandleWatchCoreV1NamespacedEndpointsRequest)
	mux.MethodFunc("GET", "/api/v1/watch/namespaces/{namespace}/endpoints", s.HandleWatchCoreV1NamespacedEndpointsListRequest)
	mux.MethodFunc("GET", "/api/v1/watch/namespaces/{namespace}/events/{name}", s.HandleWatchCoreV1NamespacedEventRequest)
	mux.MethodFunc("GET", "/api/v1/watch/namespaces/{namespace}/events", s.HandleWatchCoreV1NamespacedEventListRequest)
	mux.MethodFunc("GET", "/api/v1/watch/namespaces/{namespace}/limitranges/{name}", s.HandleWatchCoreV1NamespacedLimitRangeRequest)
	mux.MethodFunc("GET", "/api/v1/watch/namespaces/{namespace}/limitranges", s.HandleWatchCoreV1NamespacedLimitRangeListRequest)
	mux.MethodFunc("GET", "/api/v1/watch/namespaces/{namespace}/persistentvolumeclaims/{name}", s.HandleWatchCoreV1NamespacedPersistentVolumeClaimRequest)
	mux.MethodFunc("GET", "/api/v1/watch/namespaces/{namespace}/persistentvolumeclaims", s.HandleWatchCoreV1NamespacedPersistentVolumeClaimListRequest)
	mux.MethodFunc("GET", "/api/v1/watch/namespaces/{namespace}/pods/{name}", s.HandleWatchCoreV1NamespacedPodRequest)
	mux.MethodFunc("GET", "/api/v1/watch/namespaces/{namespace}/pods", s.HandleWatchCoreV1NamespacedPodListRequest)
	mux.MethodFunc("GET", "/api/v1/watch/namespaces/{namespace}/podtemplates/{name}", s.HandleWatchCoreV1NamespacedPodTemplateRequest)
	mux.MethodFunc("GET", "/api/v1/watch/namespaces/{namespace}/podtemplates", s.HandleWatchCoreV1NamespacedPodTemplateListRequest)
	mux.MethodFunc("GET", "/api/v1/watch/namespaces/{namespace}/replicationcontrollers/{name}", s.HandleWatchCoreV1NamespacedReplicationControllerRequest)
	mux.MethodFunc("GET", "/api/v1/watch/namespaces/{namespace}/replicationcontrollers", s.HandleWatchCoreV1NamespacedReplicationControllerListRequest)
	mux.MethodFunc("GET", "/api/v1/watch/namespaces/{namespace}/resourcequotas/{name}", s.HandleWatchCoreV1NamespacedResourceQuotaRequest)
	mux.MethodFunc("GET", "/api/v1/watch/namespaces/{namespace}/resourcequotas", s.HandleWatchCoreV1NamespacedResourceQuotaListRequest)
	mux.MethodFunc("GET", "/api/v1/watch/namespaces/{namespace}/secrets/{name}", s.HandleWatchCoreV1NamespacedSecretRequest)
	mux.MethodFunc("GET", "/api/v1/watch/namespaces/{namespace}/secrets", s.HandleWatchCoreV1NamespacedSecretListRequest)
	mux.MethodFunc("GET", "/api/v1/watch/namespaces/{namespace}/services/{name}", s.HandleWatchCoreV1NamespacedServiceRequest)
	mux.MethodFunc("GET", "/api/v1/watch/namespaces/{namespace}/serviceaccounts/{name}", s.HandleWatchCoreV1NamespacedServiceAccountRequest)
	mux.MethodFunc("GET", "/api/v1/watch/namespaces/{namespace}/serviceaccounts", s.HandleWatchCoreV1NamespacedServiceAccountListRequest)
	mux.MethodFunc("GET", "/api/v1/watch/namespaces/{namespace}/services", s.HandleWatchCoreV1NamespacedServiceListRequest)
	mux.MethodFunc("GET", "/api/v1/watch/nodes/{name}", s.HandleWatchCoreV1NodeRequest)
	mux.MethodFunc("GET", "/api/v1/watch/nodes", s.HandleWatchCoreV1NodeListRequest)
	mux.MethodFunc("GET", "/api/v1/watch/persistentvolumes/{name}", s.HandleWatchCoreV1PersistentVolumeRequest)
	mux.MethodFunc("GET", "/api/v1/watch/persistentvolumeclaims", s.HandleWatchCoreV1PersistentVolumeClaimListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/api/v1/watch/persistentvolumes", s.HandleWatchCoreV1PersistentVolumeListRequest)
	mux.MethodFunc("GET", "/api/v1/watch/pods", s.HandleWatchCoreV1PodListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/api/v1/watch/podtemplates", s.HandleWatchCoreV1PodTemplateListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/api/v1/watch/replicationcontrollers", s.HandleWatchCoreV1ReplicationControllerListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/api/v1/watch/resourcequotas", s.HandleWatchCoreV1ResourceQuotaListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/api/v1/watch/secrets", s.HandleWatchCoreV1SecretListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/api/v1/watch/serviceaccounts", s.HandleWatchCoreV1ServiceAccountListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/api/v1/watch/services", s.HandleWatchCoreV1ServiceListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/discovery.k8s.io/v1/watch/endpointslices", s.HandleWatchDiscoveryV1EndpointSliceListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/discovery.k8s.io/v1/watch/namespaces/{namespace}/endpointslices/{name}", s.HandleWatchDiscoveryV1NamespacedEndpointSliceRequest)
	mux.MethodFunc("GET", "/apis/discovery.k8s.io/v1/watch/namespaces/{namespace}/endpointslices", s.HandleWatchDiscoveryV1NamespacedEndpointSliceListRequest)
	mux.MethodFunc("GET", "/apis/discovery.k8s.io/v1beta1/watch/endpointslices", s.HandleWatchDiscoveryV1beta1EndpointSliceListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/discovery.k8s.io/v1beta1/watch/namespaces/{namespace}/endpointslices/{name}", s.HandleWatchDiscoveryV1beta1NamespacedEndpointSliceRequest)
	mux.MethodFunc("GET", "/apis/discovery.k8s.io/v1beta1/watch/namespaces/{namespace}/endpointslices", s.HandleWatchDiscoveryV1beta1NamespacedEndpointSliceListRequest)
	mux.MethodFunc("GET", "/apis/events.k8s.io/v1/watch/events", s.HandleWatchEventsV1EventListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/events.k8s.io/v1/watch/namespaces/{namespace}/events/{name}", s.HandleWatchEventsV1NamespacedEventRequest)
	mux.MethodFunc("GET", "/apis/events.k8s.io/v1/watch/namespaces/{namespace}/events", s.HandleWatchEventsV1NamespacedEventListRequest)
	mux.MethodFunc("GET", "/apis/events.k8s.io/v1beta1/watch/events", s.HandleWatchEventsV1beta1EventListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/events.k8s.io/v1beta1/watch/namespaces/{namespace}/events/{name}", s.HandleWatchEventsV1beta1NamespacedEventRequest)
	mux.MethodFunc("GET", "/apis/events.k8s.io/v1beta1/watch/namespaces/{namespace}/events", s.HandleWatchEventsV1beta1NamespacedEventListRequest)
	mux.MethodFunc("GET", "/apis/flowcontrol.apiserver.k8s.io/v1beta1/watch/flowschemas/{name}", s.HandleWatchFlowcontrolApiserverV1beta1FlowSchemaRequest)
	mux.MethodFunc("GET", "/apis/flowcontrol.apiserver.k8s.io/v1beta1/watch/flowschemas", s.HandleWatchFlowcontrolApiserverV1beta1FlowSchemaListRequest)
	mux.MethodFunc("GET", "/apis/flowcontrol.apiserver.k8s.io/v1beta1/watch/prioritylevelconfigurations/{name}", s.HandleWatchFlowcontrolApiserverV1beta1PriorityLevelConfigurationRequest)
	mux.MethodFunc("GET", "/apis/flowcontrol.apiserver.k8s.io/v1beta1/watch/prioritylevelconfigurations", s.HandleWatchFlowcontrolApiserverV1beta1PriorityLevelConfigurationListRequest)
	mux.MethodFunc("GET", "/apis/flowcontrol.apiserver.k8s.io/v1beta2/watch/flowschemas/{name}", s.HandleWatchFlowcontrolApiserverV1beta2FlowSchemaRequest)
	mux.MethodFunc("GET", "/apis/flowcontrol.apiserver.k8s.io/v1beta2/watch/flowschemas", s.HandleWatchFlowcontrolApiserverV1beta2FlowSchemaListRequest)
	mux.MethodFunc("GET", "/apis/flowcontrol.apiserver.k8s.io/v1beta2/watch/prioritylevelconfigurations/{name}", s.HandleWatchFlowcontrolApiserverV1beta2PriorityLevelConfigurationRequest)
	mux.MethodFunc("GET", "/apis/flowcontrol.apiserver.k8s.io/v1beta2/watch/prioritylevelconfigurations", s.HandleWatchFlowcontrolApiserverV1beta2PriorityLevelConfigurationListRequest)
	mux.MethodFunc("GET", "/apis/internal.apiserver.k8s.io/v1alpha1/watch/storageversions/{name}", s.HandleWatchInternalApiserverV1alpha1StorageVersionRequest)
	mux.MethodFunc("GET", "/apis/internal.apiserver.k8s.io/v1alpha1/watch/storageversions", s.HandleWatchInternalApiserverV1alpha1StorageVersionListRequest)
	mux.MethodFunc("GET", "/apis/networking.k8s.io/v1/watch/ingressclasses/{name}", s.HandleWatchNetworkingV1IngressClassRequest)
	mux.MethodFunc("GET", "/apis/networking.k8s.io/v1/watch/ingressclasses", s.HandleWatchNetworkingV1IngressClassListRequest)
	mux.MethodFunc("GET", "/apis/networking.k8s.io/v1/watch/ingresses", s.HandleWatchNetworkingV1IngressListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/networking.k8s.io/v1/watch/namespaces/{namespace}/ingresses/{name}", s.HandleWatchNetworkingV1NamespacedIngressRequest)
	mux.MethodFunc("GET", "/apis/networking.k8s.io/v1/watch/namespaces/{namespace}/ingresses", s.HandleWatchNetworkingV1NamespacedIngressListRequest)
	mux.MethodFunc("GET", "/apis/networking.k8s.io/v1/watch/namespaces/{namespace}/networkpolicies/{name}", s.HandleWatchNetworkingV1NamespacedNetworkPolicyRequest)
	mux.MethodFunc("GET", "/apis/networking.k8s.io/v1/watch/namespaces/{namespace}/networkpolicies", s.HandleWatchNetworkingV1NamespacedNetworkPolicyListRequest)
	mux.MethodFunc("GET", "/apis/networking.k8s.io/v1/watch/networkpolicies", s.HandleWatchNetworkingV1NetworkPolicyListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/node.k8s.io/v1/watch/runtimeclasses/{name}", s.HandleWatchNodeV1RuntimeClassRequest)
	mux.MethodFunc("GET", "/apis/node.k8s.io/v1/watch/runtimeclasses", s.HandleWatchNodeV1RuntimeClassListRequest)
	mux.MethodFunc("GET", "/apis/node.k8s.io/v1alpha1/watch/runtimeclasses/{name}", s.HandleWatchNodeV1alpha1RuntimeClassRequest)
	mux.MethodFunc("GET", "/apis/node.k8s.io/v1alpha1/watch/runtimeclasses", s.HandleWatchNodeV1alpha1RuntimeClassListRequest)
	mux.MethodFunc("GET", "/apis/node.k8s.io/v1beta1/watch/runtimeclasses/{name}", s.HandleWatchNodeV1beta1RuntimeClassRequest)
	mux.MethodFunc("GET", "/apis/node.k8s.io/v1beta1/watch/runtimeclasses", s.HandleWatchNodeV1beta1RuntimeClassListRequest)
	mux.MethodFunc("GET", "/apis/policy/v1/watch/namespaces/{namespace}/poddisruptionbudgets/{name}", s.HandleWatchPolicyV1NamespacedPodDisruptionBudgetRequest)
	mux.MethodFunc("GET", "/apis/policy/v1/watch/namespaces/{namespace}/poddisruptionbudgets", s.HandleWatchPolicyV1NamespacedPodDisruptionBudgetListRequest)
	mux.MethodFunc("GET", "/apis/policy/v1/watch/poddisruptionbudgets", s.HandleWatchPolicyV1PodDisruptionBudgetListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/policy/v1beta1/watch/namespaces/{namespace}/poddisruptionbudgets/{name}", s.HandleWatchPolicyV1beta1NamespacedPodDisruptionBudgetRequest)
	mux.MethodFunc("GET", "/apis/policy/v1beta1/watch/namespaces/{namespace}/poddisruptionbudgets", s.HandleWatchPolicyV1beta1NamespacedPodDisruptionBudgetListRequest)
	mux.MethodFunc("GET", "/apis/policy/v1beta1/watch/poddisruptionbudgets", s.HandleWatchPolicyV1beta1PodDisruptionBudgetListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/policy/v1beta1/watch/podsecuritypolicies/{name}", s.HandleWatchPolicyV1beta1PodSecurityPolicyRequest)
	mux.MethodFunc("GET", "/apis/policy/v1beta1/watch/podsecuritypolicies", s.HandleWatchPolicyV1beta1PodSecurityPolicyListRequest)
	mux.MethodFunc("GET", "/apis/rbac.authorization.k8s.io/v1/watch/clusterroles/{name}", s.HandleWatchRbacAuthorizationV1ClusterRoleRequest)
	mux.MethodFunc("GET", "/apis/rbac.authorization.k8s.io/v1/watch/clusterrolebindings/{name}", s.HandleWatchRbacAuthorizationV1ClusterRoleBindingRequest)
	mux.MethodFunc("GET", "/apis/rbac.authorization.k8s.io/v1/watch/clusterrolebindings", s.HandleWatchRbacAuthorizationV1ClusterRoleBindingListRequest)
	mux.MethodFunc("GET", "/apis/rbac.authorization.k8s.io/v1/watch/clusterroles", s.HandleWatchRbacAuthorizationV1ClusterRoleListRequest)
	mux.MethodFunc("GET", "/apis/rbac.authorization.k8s.io/v1/watch/namespaces/{namespace}/roles/{name}", s.HandleWatchRbacAuthorizationV1NamespacedRoleRequest)
	mux.MethodFunc("GET", "/apis/rbac.authorization.k8s.io/v1/watch/namespaces/{namespace}/rolebindings/{name}", s.HandleWatchRbacAuthorizationV1NamespacedRoleBindingRequest)
	mux.MethodFunc("GET", "/apis/rbac.authorization.k8s.io/v1/watch/namespaces/{namespace}/rolebindings", s.HandleWatchRbacAuthorizationV1NamespacedRoleBindingListRequest)
	mux.MethodFunc("GET", "/apis/rbac.authorization.k8s.io/v1/watch/namespaces/{namespace}/roles", s.HandleWatchRbacAuthorizationV1NamespacedRoleListRequest)
	mux.MethodFunc("GET", "/apis/rbac.authorization.k8s.io/v1/watch/rolebindings", s.HandleWatchRbacAuthorizationV1RoleBindingListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/rbac.authorization.k8s.io/v1/watch/roles", s.HandleWatchRbacAuthorizationV1RoleListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/scheduling.k8s.io/v1/watch/priorityclasses/{name}", s.HandleWatchSchedulingV1PriorityClassRequest)
	mux.MethodFunc("GET", "/apis/scheduling.k8s.io/v1/watch/priorityclasses", s.HandleWatchSchedulingV1PriorityClassListRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/v1/watch/csidrivers/{name}", s.HandleWatchStorageV1CSIDriverRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/v1/watch/csidrivers", s.HandleWatchStorageV1CSIDriverListRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/v1/watch/csinodes/{name}", s.HandleWatchStorageV1CSINodeRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/v1/watch/csinodes", s.HandleWatchStorageV1CSINodeListRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/v1/watch/storageclasses/{name}", s.HandleWatchStorageV1StorageClassRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/v1/watch/storageclasses", s.HandleWatchStorageV1StorageClassListRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/v1/watch/volumeattachments/{name}", s.HandleWatchStorageV1VolumeAttachmentRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/v1/watch/volumeattachments", s.HandleWatchStorageV1VolumeAttachmentListRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/v1alpha1/watch/csistoragecapacities", s.HandleWatchStorageV1alpha1CSIStorageCapacityListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/v1alpha1/watch/namespaces/{namespace}/csistoragecapacities/{name}", s.HandleWatchStorageV1alpha1NamespacedCSIStorageCapacityRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/v1alpha1/watch/namespaces/{namespace}/csistoragecapacities", s.HandleWatchStorageV1alpha1NamespacedCSIStorageCapacityListRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/v1beta1/watch/csistoragecapacities", s.HandleWatchStorageV1beta1CSIStorageCapacityListForAllNamespacesRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/v1beta1/watch/namespaces/{namespace}/csistoragecapacities/{name}", s.HandleWatchStorageV1beta1NamespacedCSIStorageCapacityRequest)
	mux.MethodFunc("GET", "/apis/storage.k8s.io/v1beta1/watch/namespaces/{namespace}/csistoragecapacities", s.HandleWatchStorageV1beta1NamespacedCSIStorageCapacityListRequest)
}
