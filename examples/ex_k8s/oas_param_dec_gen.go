	...
	// Decode param "dryRun" located in "Query".
	{
		...
		if ok {
			...
			if err := func() error {
				...
				return params, errors.Wrap(err, `parse parameter dryRun located in query`)
			}
		}
	}
	// Decode param "fieldManager" located in "Query".
	{
		...
		if ok {
			...
			if err := func() error {
				...
				return params, errors.Wrap(err, `parse parameter fieldManager located in query`)
			}
		}
	}
	return params, nil
	...
	// Decode param "continue" located in "Query".
	{
		...
		if ok {
			...
			if err := func() error {
				...
				return params, errors.Wrap(err, `parse parameter continue located in query`)
			}
		}
	}
	// Decode param "dryRun" located in "Query".
	...
	// Decode param "fieldSelector" located in "Query".
	{
		...
		if ok {
			...
			if err := func() error {
				...
				return params, errors.Wrap(err, `parse parameter fieldSelector located in query`)
			}
		}
	}
		...
		if ok {
			...
			if err := func() error {
				...
				if err := func() error {
					...
					ParamsGracePeriodSecondsValue = c
					return nil
				}(); err != nil {
					return err
				}
				...
				return params, errors.Wrap(err, `parse parameter gracePeriodSeconds located in query`)
			}
		}
	}
	// Decode param "labelSelector" located in "Query".
	{
		...
		if ok {
			...
			if err := func() error {
				...
				return params, errors.Wrap(err, `parse parameter labelSelector located in query`)
			}
		}
	}
	...
	// Decode param "orphanDependents" located in "Query".
	{
		...
		if ok {
			...
			if err := func() error {
				...
				return params, errors.Wrap(err, `parse parameter orphanDependents located in query`)
			}
		}
	}
		...
		if ok {
			...
			if err := func() error {
				...
				if err := func() error {
					...
					ParamsPropagationPolicyValue = c
					return nil
				}(); err != nil {
					return err
				}
				...
				return params, errors.Wrap(err, `parse parameter propagationPolicy located in query`)
			}
		}
	}
	// Decode param "resourceVersion" located in "Query".
	{
		...
		if ok {
			...
			if err := func() error {
				...
				return params, errors.Wrap(err, `parse parameter resourceVersion located in query`)
			}
		}
	}
		...
		if ok {
			...
			if err := func() error {
				...
				if err := func() error {
					...
					ParamsResourceVersionMatchValue = c
					return nil
				}(); err != nil {
					return err
				}
				...
				return params, errors.Wrap(err, `parse parameter resourceVersionMatch located in query`)
			}
		}
	}
	// Decode param "timeoutSeconds" located in "Query".
	{
		...
		if ok {
			...
			if err := func() error {
				...
				return params, errors.Wrap(err, `parse parameter timeoutSeconds located in query`)
			}
		}
	}
	return params, nil
		...
		if ok {
			...
			if err := func() error {
				...
				if err := func() error {
					...
					ParamsAllowWatchBookmarksValue = c
					return nil
				}(); err != nil {
					return err
				}
				...
				return params, errors.Wrap(err, `parse parameter allowWatchBookmarks located in query`)
			}
		}
	}
	// Decode param "continue" located in "Query".
	...
	// Decode param "watch" located in "Query".
	{
		...
		if ok {
			...
			if err := func() error {
				...
				return params, errors.Wrap(err, `parse parameter watch located in query`)
			}
		}
	}
	return params, nil
