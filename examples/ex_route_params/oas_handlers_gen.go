...
//
// GET /name
func (s *Server) handleDataGetAnyRequest(args map[string]string, w http.ResponseWriter, r *http.Request) {
...
//
// GET /name/{id}
func (s *Server) handleDataGetIDRequest(args map[string]string, w http.ResponseWriter, r *http.Request) {
