...
func (s *Server) Register(mux chi.Mux) {
	mux.MethodFunc("POST", "/pets", s.HandleCreatePetsRequest)
	mux.MethodFunc("GET", "/pets", s.HandleListPetsRequest)
	mux.MethodFunc("GET", "/pets/{petId}", s.HandleShowPetByIdRequest)
}
