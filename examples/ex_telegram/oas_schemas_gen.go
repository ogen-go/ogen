...
type Message struct {
	...
	VoiceChatStarted             OptVoiceChatStarted             `json:"voice_chat_started"`
...
func (s *Message) GetVoiceChatStarted() OptVoiceChatStarted {
...
func (s *Message) SetVoiceChatStarted(val OptVoiceChatStarted) {
...
// NewOptVoiceChatStarted returns new OptVoiceChatStarted with value set to v.
func NewOptVoiceChatStarted(v VoiceChatStarted) OptVoiceChatStarted {
	return OptVoiceChatStarted{
		Value: v,
		Set:   true,
	}
}

// OptVoiceChatStarted is optional VoiceChatStarted.
type OptVoiceChatStarted struct {
	Value VoiceChatStarted
	Set   bool
}

// IsSet returns true if OptVoiceChatStarted was set.
func (o OptVoiceChatStarted) IsSet() bool { return o.Set }

// Reset unsets value.
func (o *OptVoiceChatStarted) Reset() {
	var v VoiceChatStarted
	o.Value = v
	o.Set = false
}

// SetTo sets value to v.
func (o *OptVoiceChatStarted) SetTo(v VoiceChatStarted) {
	o.Set = true
	o.Value = v
}

// Get returns value and boolean that denotes whether value was set.
func (o OptVoiceChatStarted) Get() (v VoiceChatStarted, ok bool) {
	if !o.Set {
		return v, false
	}
	return o.Value, true
...
// Or returns value if set, or given parameter if does not.
func (o OptVoiceChatStarted) Or(d VoiceChatStarted) VoiceChatStarted {
	if v, ok := o.Get(); ok {
		return v
	}
	return d
...
type VoiceChatStarted map[string]jx.Raw

func (s *VoiceChatStarted) init() VoiceChatStarted {
	m := *s
	if m == nil {
		m = map[string]jx.Raw{}
		*s = m
