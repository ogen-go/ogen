...
// AcceptHeader represents the content of an HTTP Accept Header.
...
// AcceptHeaderNew creates a new accept header from the given media types.
...
// MatchesContentType returns true if the given content type is
// matching at least one of the content types in the accept header.
...
// DecodeURI decodes AcceptHeader from HTTP Headers.
...
// EncodeURI encodes AcceptHeader as HTTP Headers.
